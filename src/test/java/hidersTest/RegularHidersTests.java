...
public class RegularHidersTests
{
    ...
    public static final byte[] INF = ("Hello! This is my text, which i want to hide from everyone in my special picture." +
    ...
    static byte[] hideTakenOutInf(Hider hider, BufferedImage img, byte[] inf) throws IOException, HiderSizeException
    {
